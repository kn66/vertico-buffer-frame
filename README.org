...
symbols, faces, environment variables, Unicode names and colors, text-like
categories such as kill-ring and expressions, and location-like candidates from
common completion categories such as Consult grep, Consult compile errors,
Consult Flymake diagnostics, Consult Info, imenu, Org headings and xref.
