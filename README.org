...
candidate-width auto-resizing, built-in candidate preview resolvers, or
per-command Consult preview adapters.  Consult preview support mirrors
Consult's existing window preview instead of resolving every Consult command's
